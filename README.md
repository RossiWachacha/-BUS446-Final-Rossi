...
- PPIForecast.xlsx  
- Fruits and Veggies data + charts.xlsx  

Additional supporting files included:
...
- Built charts and visuals to highlight key trends  
- Interpreted category-level inflation behavior
...
- Fruits and Vegetables category trends  
- Year-to-Year and 20-Year comparison visuals  

These files contain visuals:
- Fruits and Veggies data + charts.xlsx  
- Charts for BUS 446 project.docx  
- Report on Food Inflation Dynamics slides.pptx  
...
4. Forecast errors were influenced by volatility in food supply chains.
...
- **Key Findings:** Some forecasts underestimated real inflation; PPI often signaled CPI movement.  
- **Recommendations:** Improve forecasting models, use PPI as a leading indicator, and plan for volatility in food markets.
